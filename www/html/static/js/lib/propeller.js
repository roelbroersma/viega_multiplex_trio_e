...
(function (w) {
    ...
    p.addEventListenerToTouchElement = function (eventName, callback, preventDefault) {
        this.touchElement.addEventListener(eventName, function(event) {
            callback.apply(p, [event]);
            if(preventDefault) {
    ...
    p.addListeners = function () {
        ...
        this.addEventListenerToTouchElement('touchstart', this.onRotationStart, true);
        this.addEventListenerToTouchElement('touchmove', this.onRotated, true);
        this.addEventListenerToTouchElement('touchend', this.onRotationStop, true);
        this.addEventListenerToTouchElement('touchcancel', this.onRotationStop, true);
        this.addEventListenerToTouchElement('mousedown', this.onRotationStart);
        this.addEventListenerToTouchElement('mousemove', this.onRotated);
        this.addEventListenerToTouchElement('mouseup', this.onRotationStop);
        this.addEventListenerToTouchElement('mouseleave', this.onRotationStop);
        this.addEventListenerToTouchElement('dragstart', this.returnFalse);
